...
a);SouthRidge.Utils.SetTopBar("Video");SouthRidge.Utils.DoneLoading();$(this.el).unbind().html(a).show()},events:{"tap div.video":"handleTap"},handleTap:function(a){a.preventDefault();var b=parseInt($(a.target).attr("id"));forge.tools.getURL("video.html",function(a){forge.tabs.openWithOptions({url:a+"?"+b,tint:SouthRidge.Utils.MainColor},function(a){SouthRidge.Utils.Log(a.url)})},function(){})}});
